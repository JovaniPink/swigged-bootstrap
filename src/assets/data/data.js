...
var valueTest = Object.values(cocktailDatabase).map(function (_a) {
    var ingredients = _a.ingredients;
    return ingredients;
});
var flatValueTest = valueTest.reduce(function (acc, val) { return acc.concat(val); }, []);
var flatValueTestResults = flatValueTest.map(function (element) { return element.name; });
var setFlatValueTestResults = Array.from(new Set(flatValueTestResults));
